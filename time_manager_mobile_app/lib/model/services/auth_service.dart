...
class AuthApi {
  ...
  Future<Either<Exception, String>> signin(
    ...
    try {
      ...
      final response =
          await http.post(uri, headers: apiCallHelper.headers, body: body);
      if (response.statusCode != 200) {
        throw Exception(response.body);
      }
      return Right(response.body);
  ...
  Future<Either<Exception, String>> updateProfile(
    ...
    try {
      ...
      final response =
          await http.put(uri, headers: apiCallHelper.headers, body: body);
      return Right(response.body);
    } catch (e) {
      Exception _l = Exception(e.toString());
      return (Left(_l));
  ...
  Future<Either<Exception, String>> deleteProfile(
    ...
    try {
      ...
      final response =
          await http.delete(uri, headers: apiCallHelper.headers, body: body);
      return Right(response.body);
    } catch (e) {
      Exception _l = Exception(e.toString());
      return (Left(_l));
